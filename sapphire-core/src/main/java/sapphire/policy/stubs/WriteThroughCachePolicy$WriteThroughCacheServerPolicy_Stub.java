/*
 * Stub for class sapphire.policy.cache.WriteThroughCachePolicy.WriteThroughCacheServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class WriteThroughCachePolicy$WriteThroughCacheServerPolicy_Stub extends sapphire.policy.cache.WriteThroughCachePolicy.WriteThroughCacheServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public WriteThroughCachePolicy$WriteThroughCacheServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        WriteThroughCachePolicy$WriteThroughCacheServerPolicy_Stub other = (WriteThroughCachePolicy$WriteThroughCacheServerPolicy_Stub) obj;
    ...
    public void onMembershipChange() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.cache.WriteThroughCachePolicy$WriteThroughCacheServerPolicy.onMembershipChange()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireGroupPolicy $param_SapphirePolicy$SapphireGroupPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.cache.WriteThroughCachePolicy$WriteThroughCacheServerPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireGroupPolicy)";
    ...
    public sapphire.common.AppObject getObject() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.common.AppObject sapphire.policy.cache.WriteThroughCachePolicy$WriteThroughCacheServerPolicy.getObject()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public sapphire.policy.SapphirePolicy.SapphireGroupPolicy getGroup() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.policy.SapphirePolicy$SapphireGroupPolicy sapphire.policy.cache.WriteThroughCachePolicy$WriteThroughCacheServerPolicy.getGroup()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
